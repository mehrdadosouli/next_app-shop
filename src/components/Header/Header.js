            ...
            <div className="max-w-screen-xl flex flex-row-reverse flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <Link href="/" className={`block py-2 px-3 ${pathname === '/' ? 'text-blue-700' : 'text-gray-900'} bg-blue-700 rounded-sm md:bg-transparent md:p-0 md:dark:text-blue-500`}>صفحه اصلی</Link>
                        </li>
                        <li>
                            <Link href="/shopping" className={`block py-2 px-3 ${pathname === '/shopping' ? 'text-blue-700' : 'text-gray-900'} rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700`}>فروشگاه</Link>
                        </li>
                        <li>
                            <Link href="/basket" className={`block py-2 px-3 ${pathname === '/basket' ? 'text-blue-700' : 'text-gray-900'} rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700`}>سبد خرید</Link>
                        </li>
                    </ul>
                </div>
            </div>
